...
class Cell4: UICollectionViewCell {
    ...
    var cellConNames = ["Cell4Con1", "Cell4Con2"]
...
extension Cell4: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension Cell4: UICollectionViewDelegateFlowLayout{
