...
class Cell1: UICollectionViewCell {
    ...
    var cellConNames = ["Cell1Con1", "Cell1Con2"]
...
extension Cell1: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension Cell1: UICollectionViewDelegateFlowLayout{
